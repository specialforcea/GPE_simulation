function [phi_0] = Thomas_fermi2D(Beta,X,Y,TF_radius,potential,gamma)
phi_0 = real(sqrt(((Beta/pi)^(1/2) - potential)/Beta))*sqrt(gamma); % Computing the Thomas-Fermi approximation
