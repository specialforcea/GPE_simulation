...
for mk=1:6
    ...
    for j=1:10
        ...
        save('simulation_results/11182018kick_evolve_with_soc/mom_evo.mat','mom_evo')
        save('simulation_results/11182018kick_evolve_with_soc/prof_evo.mat','prof_evo')
        save('simulation_results/11182018kick_evolve_with_soc/final_phi.mat','final_phi')
    end
end
