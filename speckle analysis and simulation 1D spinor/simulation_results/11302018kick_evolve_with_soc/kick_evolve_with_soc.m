...
for mk=1:8
    ...
    for j=1:20
        ...
        for i=1:200
            ...
            save(strcat('simulation_results/11302018kick_evolve_with_soc/phi_',num2str(mk),'_',num2str(j),'_',num2str(i),'.mat'),'phi_1')

        end
        
        final_phi(mk,j,:,:) = reshape(phi(1:2,:),[1,1,2,Nx]);
        save('simulation_results/11302018kick_evolve_with_soc/mom_evo.mat','mom_evo')
        save('simulation_results/11302018kick_evolve_with_soc/prof_evo.mat','prof_evo')
        save('simulation_results/11302018kick_evolve_with_soc/final_phi.mat','final_phi')
        save('simulation_results/11302018kick_evolve_with_soc/mean_m.mat','mean_m')
