...
speckle = speckle*1.6;%make it 70% of chemical potential.


wavepath = 'simulation_results/05012019SOC_dressed_state_8TF13/phi_1_150ms_';
savepath = 'simulation_results/05062019kick_evolve_with_soc_cluster/3_1non';
...
for mk=1:4
    ...
    for j=1:20
        ...
        for i=1:320
            phi_1 = dynamic(phi,0.005,1e-5,0,0,Nx,speckle_row,0,0,k_scale,f,deltax,deltaf,L,2*OmegaR*detuning,xmin,xmax,k_R,0);
