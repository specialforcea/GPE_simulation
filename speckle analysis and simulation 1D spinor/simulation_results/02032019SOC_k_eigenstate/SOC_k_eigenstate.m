...
for j=1:6
    ...
    %         plot(f./k_R*2*pi,sq(fourier_transform(phi,Nx,deltax)));
        ...
        save(strcat('simulation_results/02032019SOC_k_eigenstate/phi_1_25ms_318ms_grad_',num2str(j),'.mat'),'phi_1');
    end
    ...
    for i=1:320
        ...
        if draw==1 && mod(i,10)==0
            ...
            save(strcat('simulation_results/02032019SOC_k_eigenstate/spin125ms_25ms_318ms_grad_',num2str(j),'.mat'),'spin1');
            
            save(strcat('simulation_results/02032019SOC_k_eigenstate/width25ms_25ms_318ms_grad_',num2str(j),'.mat'),'width');
            save(strcat('simulation_results/02032019SOC_k_eigenstate/pos25ms_25ms_318ms_grad_',num2str(j),'.mat'),'pos');
