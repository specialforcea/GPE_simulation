...
speckle = speckle*1.6;%make it 68% of chemical potential.

wavepath = 'simulation_results/05282019SOC_dressed_state_8TF13/phi_1_150ms_';
savepath = 'simulation_results/05292019kick_evolve_with_soc_cluster_non/55';


mom_evo = zeros(21,20,2,200);
prof_evo = zeros(21,20,2,200);
mean_m = zeros(21,20,2,200);
mean_p = zeros(21,20,2,200);
spin1 = zeros(21,20,200);
...
savepath = 'simulation_results/05292019kick_evolve_with_soc_cluster/55';
