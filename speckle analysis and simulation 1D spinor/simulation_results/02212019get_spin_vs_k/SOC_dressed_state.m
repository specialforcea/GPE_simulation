...
% ks = [0.2,0.4,0.6,0.8];
% dts = (2+ks).^2 - ks.^2 - 4;
savepath = 'simulation_results/02212019SOC_dressed_state_8TF13/phi_1_12ms_';

Omega = linspace(0,OmegaR*detuning,801);
...
%         plot(f./k_R*2*pi,sq(fourier_transform(phi,Nx,deltax)));
    ...
    save(strcat(savepath,num2str(dts(j)),'d_',num2str(OmegaR),'E.mat'),'phi_1');
end
