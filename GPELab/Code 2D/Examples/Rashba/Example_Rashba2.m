...
delta_Beta = 1.5;
Beta_11 = 800;
Beta_12 = Beta_11*delta_Beta;
Beta_22 = Beta_11;
Beta_coupled = [Beta_11,Beta_12;Beta_12,Beta_22];
Kappa = 2;
Omega = 0;

Physics2D = Physics2D_Var2d(Method, Delta, 1, Omega);
...
pause
close all
Draw_Spin2d(Phi, Method, Geometry2D, Figure);