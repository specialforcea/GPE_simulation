...
function FPLaplace = RSPFPLaplace2d(Method, FFTPhysics2D, FFTGeometry2D)
%% Initialization of the potential and nonlinear matricial operators 
DispMat = cell(Method.Ncomponents);
for n = 1:Method.Ncomponents
    for m = 1:Method.Ncomponents
        DispMat{n,m} = (n == m)*1/Method.Deltat + FFTPhysics2D.Dispersion{n,m}/2 + FFTPhysics2D.TimeDispersionImp{n,m}/2 + FFTPhysics2D.StochasticDispersion{n,m}/2;
    end
end
