...
function FPTHomasFermi = BESPFPThomas_Fermi2d(Method, FFTPhysics2D, FFTGeometry2D)
%% Initialization of the potential and nonlinear matricial operators 
PotNLMat = cell(Method.Ncomponents);
for n = 1:Method.Ncomponents
    for m = 1:Method.Ncomponents
        PotNLMat{n,m} = (n == m)*1/Method.Deltat + FFTPhysics2D.Potential{n,m} + FFTPhysics2D.TimePotential{n,m}+ FFTPhysics2D.Beta*FFTPhysics2D.Nonlinearity{n,m} + FFTPhysics2D.Beta*FFTPhysics2D.FFTNonlinearity{n,m};
    end
end
