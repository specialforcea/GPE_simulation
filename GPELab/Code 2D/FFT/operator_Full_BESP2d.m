...
function [Phi_out] = operator_Full_BESP2d(Phi_in, Method, FFTGeometry2D, FFTPhysics2D, FFTOperators2D)
...
for n = 1:Method.Ncomponents
    ...
    GPE_Phi = GPE_Phi + 1/Method.Deltat*Phi{n} ...
        + ifft2(FFTPhysics2D.Dispersion{n,n}.*fft2(Phi{n})); % Computing the wave function with the potential, nonlinear and Laplacian operators applied
