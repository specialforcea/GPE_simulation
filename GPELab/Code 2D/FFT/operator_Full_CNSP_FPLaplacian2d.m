%% Applying the operators corresponding to the implicit part of the CNSP-CNFG scheme with the full Laplace preconditioner
%% INPUTS:
...
function [Phi_out] = operator_Full_CNSP_FPLaplacian2d(Phi_in, Method, FFTGeometry2D, FFTPhysics2D, FFTOperators2D)
