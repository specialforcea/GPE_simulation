%% Applying the operators corresponding to the implicit part of the CNSP-CNFG scheme with the full Thomas-Fermi preconditioner
%% INPUTS:
...
function [Phi_out] = operator_Full_CNSP_FPThomasFermi2d(Phi_in, Method, FFTGeometry2D, FFTPhysics2D, FFTOperators2D)
...
for n = 1:Method.Ncomponents
    ...
    GPE_Phi{n} = GPE_Phi{n} + ifft2(FFTPhysics2D.Dispersion{n,n}/2.*fft2(Phi{n})); % Computing the wave function with the Laplacian operator applied
end
