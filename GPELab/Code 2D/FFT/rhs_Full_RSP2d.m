...
function [Phi_out] = rhs_Full_RSP2d(Phi_in, Psi, FFTPsi, Method, FFTGeometry2D, FFTPhysics2D, FFTOperators2D)
...
Phi_out = zeros(FFTGeometry2D.Ny,Method.Ncomponents*FFTGeometry2D.Nx); % Initializing the variable for the components' wave functions with the operators and the preconditionner applied
