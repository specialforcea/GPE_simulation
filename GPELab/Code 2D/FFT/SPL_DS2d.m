...
function [Phi_final, Outputs] = SPL_DS2d(Phi_0, Method, Geometry2D, Physics2D, Outputs, Print, Figure)
...
while (Method.Iterations*Method.Deltat<Method.Stop_time)
    ...
    FFTPhi = Local_Splitting_solution2d(FFTPhi, Method, FFTGeometry2D, FFTPhysics2D, FFTOperators2D); % Computation of the ground state using the full BESP-CNFG method on a single step of time
    %% Updating CPUtime
