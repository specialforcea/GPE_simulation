...
function [Phi_out] = rhs_Full_CNSP_PLaplacian2d(Phi_in, Method, FFTGeometry2D, FFTPhysics2D, FFTOperators2D)
...
for n = 1:Method.Ncomponents
    ...
    GPE_Phi = ifft2((1/Method.Deltat + FFTPhysics2D.Dispersion{n,n}/2).^(-1).*fft2(GPE_Phi)); % Applying the Laplace preconditioner
