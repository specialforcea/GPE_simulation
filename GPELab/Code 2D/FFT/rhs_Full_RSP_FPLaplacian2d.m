...
for n = 1:Method.Ncomponents
    ...
    FFTGPE_Phi{n} = fft2(GPE_Phi) + 1/Method.Deltat*fft2(Phi{n});
end
...
for n = 1:Method.Ncomponents
    ...
    Phi_out(:,(1+(n-1)*FFTGeometry2D.Nx):(n*FFTGeometry2D.Nx)) = ifft2(FFTPhi); % Storing the wave function with the operators and the preconditioner applied
end
