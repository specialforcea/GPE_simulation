%% Crank Nichoslon SPectral for the Dynamic System (CNSP-DS) : Semi-implicit FFT scheme for the computation of solutions of the dynamic Gross Pitaevskii equation
%% INPUTS:
...
function [Phi_final, Outputs] = CNSP_DS2d(Phi_0, Method, Geometry2D, Physics2D, Outputs, Print, Figure)
...
%% Computation of dynamic of the GPE via CNSP
