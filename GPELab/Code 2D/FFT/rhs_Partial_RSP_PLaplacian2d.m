...
function [Phi_out] = rhs_Partial_RSP_PLaplacian2d(Phi, Psi, FFTPsi, Method, FFTGeometry2D, FFTPhysics2D, FFTOperators2D)
...
Phi_out = cell(1,Method.Ncomponents);
...
for n = 1:Method.Ncomponents
    ...
    Phi_out{n} = GPE_Phi + 1/Method.Deltat*Phi{n} ...
        + ifft2(( - FFTPhysics2D.Dispersion{n,n}/2 - FFTPhysics2D.StochasticDispersion{n,n}/2).*fft2(Phi{n})); % Computing the wave function with the potential, nonlinear and Laplacian operators applied
end