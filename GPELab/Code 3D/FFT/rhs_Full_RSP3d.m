%% Applying the operators corresponding to the explicit part of the RSP scheme
%% INPUTS:
...
function [Phi_out] = rhs_Full_RSP3d(Phi_in, Psi, FFTPsi, Method, FFTGeometry3D, FFTPhysics3D, FFTOperators3D)
...
Phi_out = zeros(FFTGeometry3D.Ny,FFTGeometry3D.Nx,Method.Ncomponents*FFTGeometry3D.Nz); % Initializing the variable for the components' wave functions with the operators and the preconditionner applied
