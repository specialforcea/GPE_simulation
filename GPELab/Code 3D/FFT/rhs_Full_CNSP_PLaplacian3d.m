%% Applying the operators corresponding to the explicit part of the BESP-CNFG scheme with the Laplace preconditioner
%% INPUTS:
...
function [Phi_out] = rhs_Full_CNSP_PLaplacian3d(Phi_in, Method, FFTGeometry3D, FFTPhysics3D, FFTOperators3D)
...
for n = 1:Method.Ncomponents
    ...
    GPE_Phi = ifftn((1/Method.Deltat + FFTPhysics3D.Dispersion{n,n}/2).^(-1).*fftn(GPE_Phi)); % Applying the Laplace preconditioner
