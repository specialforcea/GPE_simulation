...
function [Phi_out] = operator_Full_BESP_FPLaplacian3d(Phi_in, Method, FFTGeometry3D, FFTPhysics3D, FFTOperators3D)
...
for n = 1:Method.Ncomponents
    ...
    FFTGPE_Phi{n} = fftn(GPE_Phi); % Storing the wave function with the operators and the preconditionner applied
end
