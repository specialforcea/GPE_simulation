...
function [Phi_out] = operator_Full_BESP3d(Phi_in, Method, FFTGeometry3D, FFTPhysics3D, FFTOperators3D)
...
for n = 1:Method.Ncomponents
    ...
    GPE_Phi = GPE_Phi + 1/Method.Deltat*Phi{n} ...
        + ifftn(FFTPhysics3D.Dispersion{n,n}.*fftn(Phi{n})); % Computing the wave function with the potential, nonlinear and Laplacian operators applied
