...
function [Phi_out] = rhs_Full_RSP_PThomasFermi3d(Phi_in, Psi, FFTPsi, Method, FFTGeometry3D, FFTPhysics3D, FFTOperators3D)
...
for n = 1:Method.Ncomponents
    ...
    GPE_Phi = 1./(1/Method.Deltat + FFTPhysics3D.Potential{n,n}/2 + FFTPhysics3D.TimePotentialImp{n,n}/2 + FFTPhysics3D.StochasticPotential{n,n}/2 + FFTPhysics3D.Beta*Psi{n,n}/2 + FFTPhysics3D.Beta*FFTPsi{n,n}/2).*GPE_Phi; % Applying the Thomas-Fermi preconditioner
