...
%%          Outputs: Different outputs computed during the computation of the ground state (structure) (see OutputsINI_Var3D.m and FFTOutputs_Var3d.m)
...
%%          Local_Full_CNSP_solution3d: To compute the CNGF on a single time step using the CNSP method (line 59)
%%          L2_norm3d: To compute the normalized wave function (line 65)
%%          FFTOutputs_Var3d: To compute output variables (line 78,82 and 95)
%%          Print_Info3d: To print informations concerning the wave functions (line 85 and 96)
%%          Draw_solution3d: To draw the ground states (line 89)

function [Phi_final, Outputs] = CNSP_CNGF3d(Phi_0, Method, Geometry3D, Physics3D, Outputs, Print, Figure)
