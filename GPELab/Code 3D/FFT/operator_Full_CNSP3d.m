%% Applying the operators corresponding to the implicit part of the CNSP-CNFG scheme
%% INPUTS:
...
function [Phi_out] = operator_Full_CNSP3d(Phi_in, Method, FFTGeometry3D, FFTPhysics3D, FFTOperators3D)
