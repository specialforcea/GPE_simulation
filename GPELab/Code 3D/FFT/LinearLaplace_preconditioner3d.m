...
function [Phi_out] = LinearLaplace_preconditioner3d(Phi_in, Method, FFTGeometry3D, FFTPhysics3D)
...
Phi = ifftn((1/Method.Deltat + FFTPhysics3D.Dispersion{n,n}).^(-1).*fftn(Phi)); % Applying the Laplace preconditoner
