...
function [Phi_out] = rhs_Full_CNSP_FPThomasFermi3d(Phi_in, Method, FFTGeometry3D, FFTPhysics3D, FFTOperators3D)
...
for n = 1:Method.Ncomponents
    ...
    for m = 1:Method.Ncomponents
        Phi_tmp = Phi_tmp + FFTPhysics3D.FPThomasFermi{n,m}.*GPE_Phi{m}; % Applying the Thomas-Fermi preconditioner
    end
