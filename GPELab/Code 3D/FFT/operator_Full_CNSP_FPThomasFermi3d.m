%% Applying the operators corresponding to the implicit part of the CNSP-CNFG scheme with the Thomas-Fermi preconditioner
%% INPUTS:
...
function [Phi_out] = operator_Full_CNSP_FPThomasFermi3d(Phi_in, Method, FFTGeometry3D, FFTPhysics3D, FFTOperators3D)
