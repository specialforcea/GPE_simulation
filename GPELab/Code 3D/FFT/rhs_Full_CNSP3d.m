%% Applying the operators corresponding to the explicit part of the CNSP-CNFG scheme
%% INPUTS:
...
function [Phi_out] = rhs_Full_CNSP3d(Phi_in, Method, FFTGeometry3D, FFTPhysics3D, FFTOperators3D)
