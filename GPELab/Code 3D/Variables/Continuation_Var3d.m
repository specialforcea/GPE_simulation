...
%% INPUTS:
%%          Coefficient: Evolution of the coefficient during each computation of the continuation (cell array of matrices or doubles)
%%          Coefficient_name: Name associated to the coefficient (string)
%%          (Must either be: 'Delta','Beta','Omega','GPotential','GNonlinearity','GGradientx','GGradienty','GGradientz')
%% INPUTS(OPTIONAL):
...
function [Continuation] = Continuation_Var3d(varargin)
%% Analysis of the inputs
valid_Coefficient_name = {'Delta','Beta','Omega','GPotential','GNonlinearity','GFFTNonlinearity','GGradientx','GGradienty','GGradientz'}; % List of valid inputs for the coefficient name
