...
function Phi = Local_Direct_BEFD_solution1d(Phi, Method, FDGeometry1D, FDPhysics1D, FDOperators1D)
...
M = (1/Method.Deltat)*FDOperators1D.Id + FDOperators1D.Linear_Operators + FDPhysics1D.Beta*FDOperators1D.Nonlinearity_matrix + FDOperators1D.TimePotential_matrix; % Computation of the system
