...
%%          Local_Krylov_CNFD_solution1d: To compute the CNFG on a single time step using the iterative CNFD method (line 57)
%%          Local_Direct_CNFD_solution1d: To compute the CNFG on a single time step using the direct CNFD method (line 63)
...
function [Phi_final, Outputs] = CNFD_DS1d(Phi_0, Method, Geometry1D, Physics1D, Outputs, Print, Figure)
