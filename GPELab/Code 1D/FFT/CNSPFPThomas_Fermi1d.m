...
function FPTHomasFermi = CNSPFPThomas_Fermi1d(Method, FFTPhysics1D, FFTGeometry1D)
%% Initialization of the potential and nonlinear matricial operators 
PotNLMat = cell(Method.Ncomponents);
for n = 1:Method.Ncomponents
    for m = 1:Method.Ncomponents
        PotNLMat{n,m} = (n == m)*1/Method.Deltat + FFTPhysics1D.Potential{n,m}/2 + FFTPhysics1D.TimePotential{n,m}/2 + FFTPhysics1D.Beta*FFTPhysics1D.Nonlinearity{n,m}/2 + FFTPhysics1D.Beta*FFTPhysics1D.FFTNonlinearity{n,m}/2;
    end
end
