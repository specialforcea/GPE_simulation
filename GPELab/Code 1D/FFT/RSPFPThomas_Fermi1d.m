...
function FPTHomasFermi = RSPFPThomas_Fermi1d(Psi, FFTPsi, Method, FFTPhysics1D, FFTGeometry1D)
%% Initialization of the potential and nonlinear matricial operators 
PotNLMat = cell(Method.Ncomponents);
for n = 1:Method.Ncomponents
    for m = 1:Method.Ncomponents
        PotNLMat{n,m} = (n == m)*1/Method.Deltat + FFTPhysics1D.Potential{n,m}/2 + FFTPhysics1D.TimePotentialImp{n,m}/2 + FFTPhysics1D.StochasticPotential{n,m}/2 + FFTPhysics1D.Beta*Psi{n,m}/2 + FFTPhysics1D.Beta*FFTPsi{n,m}/2;
    end
end
