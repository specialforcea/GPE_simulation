...
function [Phi_out] = operator_Full_BESP_FPLaplacian1d(Phi_in, Method, FFTGeometry1D, FFTPhysics1D, FFTOperators1D)
...
for n = 1:Method.Ncomponents
    ...
    for m = 1:Method.Ncomponents
        FFTPhi = FFTPhi + FFTPhysics1D.FPLaplace{n,m}.*FFTGPE_Phi{m}; % Applying the Thomas-Fermi preconditioner
    end
