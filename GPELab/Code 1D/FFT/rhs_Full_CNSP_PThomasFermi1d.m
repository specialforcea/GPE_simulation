...
function [Phi_out] = rhs_Full_CNSP_PThomasFermi1d(Phi_in, Method, FFTGeometry1D, FFTPhysics1D, FFTOperators1D)
...
for n = 1:Method.Ncomponents
    ...
    GPE_Phi = 1./(1/Method.Deltat + FFTPhysics1D.Potential{n,n}/2+ FFTPhysics1D.TimePotential{n,n}/2+ FFTPhysics1D.Beta*FFTPhysics1D.Nonlinearity{n,n}/2 + FFTPhysics1D.Beta*FFTPhysics1D.FFTNonlinearity{n,n}/2).*GPE_Phi; % Applying the Thomas-Fermi preconditioner
