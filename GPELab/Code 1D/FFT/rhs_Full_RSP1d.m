%% Applying the operators corresponding to the explicit part of the RSP-CNFG scheme
%% INPUTS:
...
function [Phi_out] = rhs_Full_RSP1d(Phi_in, Psi, FFTPsi, Method, FFTGeometry1D, FFTPhysics1D, FFTOperators1D)
