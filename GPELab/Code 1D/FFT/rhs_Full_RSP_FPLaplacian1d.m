...
function [Phi_out] = rhs_Full_RSP_FPLaplacian1d(Phi_in, Psi, FFTPsi, Method, FFTGeometry1D, FFTPhysics1D, FFTOperators1D)
...
for n = 1:Method.Ncomponents
    ...
    FFTGPE_Phi{n} = fft(GPE_Phi)  ...
        + (1/Method.Deltat - FFTPhysics1D.Dispersion{n,n}/2  - FFTPhysics1D.StochasticDispersion{n,n}/2).*fft(Phi{n}); % Computing the wave function with the potential, nonlinear and Laplacian operators applied
end
