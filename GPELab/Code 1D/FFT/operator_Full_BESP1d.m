%% Applying the operators corresponding to the implicit part of the BESP-CNFG scheme
%% INPUTS:
...
function [Phi_out] = operator_Full_BESP1d(Phi_in, Method, FFTGeometry1D, FFTPhysics1D, FFTOperators1D)
...
for n = 1:Method.Ncomponents
    ...
    GPE_Phi = GPE_Phi + 1/Method.Deltat*Phi{n} ...
        + ifft(FFTPhysics1D.Dispersion{n,n}.*fft(Phi{n})); % Computing the wave function with the potential, nonlinear and Laplacian operators applied
