...
function [Phi_out] = rhs_Full_CNSP1d(Phi_in, Method, FFTGeometry1D, FFTPhysics1D, FFTOperators1D)
...
for n = 1:Method.Ncomponents
    ...
    GPE_Phi = GPE_Phi +1/Method.Deltat*Phi{n} ...
        + ifft((- FFTPhysics1D.Dispersion{n,n}/2).*fft2(Phi{n})); % Computing the wave function with the potential, nonlinear and Laplacian operators applied
