...
%%          outputs: User defined functions for each component which depend on (phi,X) to be stored and printed in the informations (cell array of functions)
...
function [Outputs] = OutputsINI_Var1d(Method, Evo_outputs, save, userdef_outputs, userdef_outputs_names, globaluserdef_outputs, globaluserdef_outputs_names)
%% Initialization of the Outputs variables
    ...
    if (nargin >=2) && (isempty(Evo_outputs) == 0) && (Evo_outputs > 0)
...
% IF there are user defined outputs functions
