...
%%          Printing: Variable containing the choice to draw or not to draw wave functions during the computation (double, Default: 0)
...
function [Print] = Print_Var1d(varargin)
