...
mom_evo = zeros(20,300);
prof_evo = zeros(20,300);
mean_m = zeros(20,300);
mean_p = zeros(20,300);
poten = zeros(20,300);
final_phi = zeros(20,100,Nx);

for k=1:10
    speckle_ = speckle*(k-1)*80;
    save_path = strcat('simulation_results/09032020speckle_pulse_exp_condition_cluster_6_measure_poten_long/',num2str((k-1)*200),'/');
