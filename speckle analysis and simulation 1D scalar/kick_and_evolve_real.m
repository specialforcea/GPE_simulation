...
speckle = speckle*5;%make it 68% of chemical potential,200Hz.

save_path = 'simulation_results/10282019kick_and_evolve_real/200/';
mom_evo = zeros(21,20,13);
prof_evo = zeros(21,20,13);
mean_m = zeros(21,20,13);
mean_p = zeros(21,20,13);
...
speckle = speckle*2;%make it 68% of chemical potential,400Hz.

save_path = 'simulation_results/10282019kick_and_evolve_real/400/';
mom_evo = zeros(21,20,13);
prof_evo = zeros(21,20,13);
mean_m = zeros(21,20,13);
mean_p = zeros(21,20,13);
...
speckle = speckle*1.5;%make it 68% of chemical potential,600Hz.

save_path = 'simulation_results/10282019kick_and_evolve_real/600/';
mom_evo = zeros(21,20,13);
prof_evo = zeros(21,20,13);
mean_m = zeros(21,20,13);
mean_p = zeros(21,20,13);
