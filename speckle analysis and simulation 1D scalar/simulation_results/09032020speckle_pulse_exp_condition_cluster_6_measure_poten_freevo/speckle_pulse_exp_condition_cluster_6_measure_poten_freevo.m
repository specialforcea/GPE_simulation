...
mom_evo = zeros(20,310);
prof_evo = zeros(20,310);
mean_m = zeros(20,310);
mean_p = zeros(20,310);
poten = zeros(20,60);
final_phi = zeros(20,70,Nx);

for k=1:10
    speckle_ = speckle*(k-1)*80;
    save_path = strcat('simulation_results/09032020speckle_pulse_exp_condition_cluster_6_measure_poten_freevo/',num2str((k-1)*200),'/');
    ...
    for j=1:20
        ...
        for i=61:310
            ...
            phi = phi_1;
            if mod(i,5)==0
                final_phi(j,int32((i+40)/5),:) = reshape(phi(1,:),[1,1,Nx]);
            end
