...
for o = 1:3
    ...
    for j=1:10
        ...
        for i=1:300
            ...
            mom_evo_10(1,j,i) = sqrt(integr(f.^2.*fp,Nx,deltaf));
            prof_evo_10(1,j,i) = sqrt(integr(X.^2.*sq(phi_1(1,:)),Nx,deltax));
...
for o = 1:3
    ...
    for j=1:10
        ...
        for i=1:300
            ...
            mom_evo_12(1,j,i) = sqrt(integr(f.^2.*fp,Nx,deltaf));
            prof_evo_12(1,j,i) = sqrt(integr(X.^2.*sq(phi_1(1,:)),Nx,deltax));
