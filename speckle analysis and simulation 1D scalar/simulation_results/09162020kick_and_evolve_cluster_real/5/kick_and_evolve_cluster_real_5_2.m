...
speckle_ = speckle*10.5;%make it 68% of chemical potential,700Hz.

save_path = 'simulation_results/09162020kick_and_evolve_cluster_real/5/700/';
...
speckle_ = speckle*12.0;%make it 68% of chemical potential,800Hz.

save_path = 'simulation_results/09162020kick_and_evolve_cluster_real/5/800/';
mom_evo = zeros(21,20,65);
prof_evo = zeros(21,20,65);
mean_m = zeros(21,20,65);
mean_p = zeros(21,20,65);
