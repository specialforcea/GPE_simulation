...
speckle_ = speckle*200;%make it 68% of chemical potential,500Hz.

save_path = 'simulation_results/09162020kick_and_evolve_cluster_real/6/500/';
...
speckle_ = speckle*280;%make it 68% of chemical potential,700Hz.

save_path = 'simulation_results/09162020kick_and_evolve_cluster_real/6/700/';
mom_evo = zeros(21,20,65);
prof_evo = zeros(21,20,65);
mean_m = zeros(21,20,65);
mean_p = zeros(21,20,65);
...
speckle_ = speckle*320;%make it 68% of chemical potential,800Hz.

save_path = 'simulation_results/09162020kick_and_evolve_cluster_real/6/800/';
mom_evo = zeros(21,20,65);
prof_evo = zeros(21,20,65);
mean_m = zeros(21,20,65);
mean_p = zeros(21,20,65);
