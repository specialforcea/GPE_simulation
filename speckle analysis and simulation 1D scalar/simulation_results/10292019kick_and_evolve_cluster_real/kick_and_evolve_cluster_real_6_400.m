...
speckle = speckle*160;%make it 68% of chemical potential,400Hz.

save_path = 'simulation_results/10292019kick_and_evolve_cluster_real/6/400/';
mom_evo = zeros(21,20,200);
prof_evo = zeros(21,20,200);
mean_m = zeros(21,20,200);
mean_p = zeros(21,20,200);
