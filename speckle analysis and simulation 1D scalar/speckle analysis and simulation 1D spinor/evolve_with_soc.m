...
for o=1:3
    ...
    for j=1:10
        ...
        save('simulation_results/10262018evolve_with_soc/mom_evo_10.mat','mom_evo_10');
        save('simulation_results/10262018evolve_with_soc/final_phi_10.mat','final_phi_10');
        save('simulation_results/10262018evolve_with_soc/prof_evo_10.mat','prof_evo_10');
    end
end
...
for o=1:3
    ...
    for j=1:10
        ...
        save('simulation_results/10262018evolve_with_soc/mom_evo_12.mat','mom_evo_12');
        save('simulation_results/10262018evolve_with_soc/final_phi_12.mat','final_phi_12');
        save('simulation_results/10262018evolve_with_soc/prof_evo_12.mat','prof_evo_12');
    end
end
